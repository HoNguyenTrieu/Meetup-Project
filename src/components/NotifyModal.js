...
const NotifyModal = () => {
  ...
  const handleDeleteAll = () => {
    ...
    const announce = alert("Your notifications are cleaned!", {
  ...
  return (
    <div style={{ minWidth: "280px" }}>
      ...
      <hr className="mt-0" />
      {notify.data.length === 0 && <img src={NoNotice} alt="No_Notice" />}
          ...
          <div key={index} className="px-2 mb-3">
            ...
            >
              ...
              <div style={{ width: "30px" }}>
                {msg.image && <Avatar src={msg.image} size="medium-image" />}
              </div>
            </Link>
